        ...
        child: Column(
          children: [
            Container(
              ...
              child: Center(
                child: Text("Crie uma conta como uma empresa", style: TextStyle(color: Colors.white),),
              ),
            ),
            Container(
              height: 5 * heightScale,
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Center(
                child: Text("Crie uma conta como um investidor", style: TextStyle(color: Colors.white),),
              ),
            ),
            Container(
              height: 5 * heightScale,
